...
export let options = {
  stages: [
    ...
    { duration: '5s', target: 100 }, // normal load (20/s)
   // { duration: '5s', target: 300 }, // around the breaking point (60/s)
    { duration: '5s', target: 500 }, // beyond the breaking point (100/s)
   // { duration: '5s', target: 1000 }, // beyond breaking point (200/s)
    { duration: '5s', target: 0 }, // scale down. Recovery stage.
  ],
  thresholds: {
    http_req_failed: [{
      threshold: 'rate<0.05', // errors less than 1%
      abortOnFail: true
    }],
